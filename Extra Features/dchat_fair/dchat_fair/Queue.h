...
public:
    socket_queue_item()=default;
    socket_queue_item(int sockfd, sockaddr_storage * their_addr, Address fromAddr, std::string message){
        this->sockfd = sockfd;
        if(their_addr) {
